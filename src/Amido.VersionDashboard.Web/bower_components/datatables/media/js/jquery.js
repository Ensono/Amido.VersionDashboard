...
!function(a, b) {
    ...
    var s = function(a) {
        ...
        c = fb.support = {}, f = fb.isXML = function(a) {
            ...
            preFilter: {
                ATTR: function(a) { return a[1] = a[1].replace(cb, db), a[3] = (a[3] || a[4] || a[5] || '').replace(cb, db), '~=' === a[2] && (a[3] = ' ' + a[3] + ' '), a.slice(0, 4) }, CHILD: function(a) { return a[1] = a[1].toLowerCase(), 'nth' === a[1].slice(0, 3) ? (a[3] || fb.error(a[0]), a[4] = +(a[4] ? a[5] + (a[6] || 1) : 2 * ('even' === a[3] || 'odd' === a[3])), a[5] = +(a[7] + a[8] || 'odd' === a[3])) : a[3] && fb.error(a[0]), a },
                PSEUDO: function(a) {
                    var b, c = !a[6] && a[2];
    ...
    m.event = {
        ...
        isDefaultPrevented: bb, isPropagationStopped: bb, isImmediatePropagationStopped: bb,
