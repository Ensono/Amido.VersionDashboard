...
!function(a) {
...
}(window || this), function(a, b) { 'function' == typeof define && define.amd ? define(['eve'], function(c) { return b(a, c) }) : b(a, a.eve || 'function' == typeof require && require('eve')) }(this, function(a, b) {
    function c(a) {
        if (c.is(a, 'function')) {
    ...
    c.getRGB = f(function(a) {
        ...
        return c.is(a, V) && c.is(a[0], V) && (e = Cb(a)), e.length || I(a).replace(hb, function(a, b, c) {
            ...
            if (c.replace(jb, function(a, b) { b && f.push(+b) }), 'm' == g && f.length > 2 && (e.push([b][E](f.splice(0, 2))), g = 'l', b = 'm' == b ? 'l' : 'L'), 'r' == g) {
                e.push([b][E](f));
            } else {
    ...
    var Bb = c.pathBBox = function(a) {
        ...
        Hb = function(a, b, c, d, e, g, h, i, j, k) {
            var l, m = 120 * S / 180, n = S / 180 * (+e || 0), o = [],
                p = f(function(a, b, c) {
        ...
        Kb = c._path2curve = f(function(a, b) {
            ...
            for (var d = Eb(a),
                ...
                j = function(a, b, c, f, g) { a && b && 'M' == a[g][0] && 'M' != b[g][0] && (b.splice(g, 0, ['M', f.x, f.y]), c.bx = 0, c.by = 0, c.x = a[g][1], c.y = a[g][2], p = O(d.length, e && e.length || 0)) },
                k = [],
                l = [],
                m = '',
                n = '',
                o = 0,
                p = O(d.length, e && e.length || 0); p > o; o++) {
    ...
    var hc = c.easing_formulas = {
        linear: function(a) { return a }, "<": function(a) { return R(a, 1.7) }, ">": function(a) { return R(a, .48) },
        "<>": function(a) {
    ...
    return nc.attr = function(a, b) {
    ...
    }(), c.ninja = function() { return B.was ? A.win.Raphael = B.is : delete Raphael, c }, c.st = nc, b.on('raphael.DOMload', function() { u = !0 }), function(a, b, d) {
        ...
        if (c.svg) {
            ...
            }, B.translate = function(a, c) { return this.removed ? this : (a = b(a).split(j), a.length - 1 && (c = d(a[1])), a = d(a[0]) || 0, c = +c || 0, this.transform(this._.transform.concat([['t', a, c]])), this) }, B.transform = function(b) {
                var d = this._;
                if (null == b) {
                    return d.transform;
                }
